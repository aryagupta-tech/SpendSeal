import type { AuditEvent, BrowserPurchasePermit, PurchasePermit, Merchant, PaymentOrder, Product, ShoppingCandidate, ShoppingTask, User } from "@spendseal/core";
...
export type ShoppingTaskResponse = { task: ShoppingTask; candidates: ShoppingCandidate[]; permit: BrowserPurchasePermit | null };
