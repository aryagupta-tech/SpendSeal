...
const task: ShoppingTask = { id: "11111111-1111-4111-8111-111111111111", buyerId: "22222222-2222-4222-8222-222222222222", site: "amazon_in", query: "headphones", productUrl: null, maxTotalPaise: 100_000, requireRefundable: false, minimumReturnWindowDays: null, latestDeliveryDate: null, quantity: 1, currency: "INR", status: "approved", selectedCandidateId: "33333333-3333-4333-8333-333333333333", purchasePermitId: "44444444-4444-4444-8444-444444444444", checkoutSnapshotHash: null, confirmedAt: now.toISOString(), denialReason: null, mode: "prepare_only", expiresAt: "2026-08-28T10:10:00.000Z", createdAt: now.toISOString(), updatedAt: now.toISOString() };
